...
<div class="row">
  <div class="col-md-6">
    <div class="row">
      <div class="col-md-12">
        <h3><?php echo $this->lang->line('apntmnt_new_event');?></h3>
        <blockquote>
                  ...
                  <?php foreach ($past as $row) : ?>
                    <tr>
                      ...
                      <td class="<?php echo !$row->read ? 'warning' : ''; ?>">
                        ...
                        <?php endif; ?>
                        <h4>Notizen <small><?php echo form_prep($row->text_<?php echo $this->lang->line('apntmnt_pat_name');?>_notes); ?></small></h4>
                        "><span class="icomoon i-info-2"></span></button>
                        <?php if (!$row->accept) : ?>
                          <button class="btn btn-success" rel="tooltip" data-toggle="tooltip" data-placement="top" title="akzeptieren" ia-action="reservation-action" data-action-submit="[ia-action='reservation-action'][data-action='accept']:first" data-action-checkbox="[name='checked_reservation[<?php echo $row->id; ?>]']"><span class="icomoon i-checkmark-circle-2"></span></button>
                        <?php endif; ?>
...
<div class="row">
  <div class="col-md-12">
    ...
    <blockquote>
      <p><small><?php echo $this->lang->line('apntmnt_old_header_info');?></small></p>
    </blockquote>
    <div class="well-sm">
