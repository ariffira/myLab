<div class="row">
  <div class="col-md-6" id="info-block">
    <div class="bs-callout bs-callout-danger">
      <h4 class="h2">Ihre Terminwahl</h4>
      <div class="alert alert-danger termin-timebar" role="alert">
        <div class="h4">
          <span class="light">Am:</span>
          <strong><?php echo $termin->start; ?></strong>
        </div>
      </div>
      <ul class="media-list">
        <li class="media">
          <a class="pull-left thumbnail col-md-4" href="#">
            ...
            <?php //if (isset($doctor->native->avatar) && $doctor->native->avatar) : ?>
            <!-- <img src="<?php echo $doctor->native->avatar; ?>" alt="<?php echo $doctor->academic_grade.' '.$doctor->name.' '.$doctor->surname; ?>"> -->
            <?php //else : ?>
              <!-- <img src="//placehold.it/360x640" /> -->
            <?php //endif; ?>
          </a>
          <div class="media-body">
            <h5 class="media-heading">
              <div class="conjunction">bei</div>
              <div class="name h3" style="margin-top:0;"><?php echo $doctor->academic_grade.' '.$doctor->name.' '.$doctor->surname; ?></div>
            </h5>
            <p>
              <a href="tel:<?php echo $doctor->telephone; ?>" class="phone h4"><span class="icomoon i-phone-2"></span> <?php echo $doctor->telephone; ?></a>
            </p>
  ...
  <div class="col-md-6" id="form">
    <div class="bs-callout bs-callout-info">
      ...
      <form id="booking-form" class="  " action="<?php echo site_url('termin/portal/reservation/reserve'); ?>" method="post" enctype="application/x-www-form-urlencoded" >
        ...
        <input type="hidden" name="user_id" value="<?php echo $this->m->user_id(); ?>">
        <input type="hidden" name="user_role" value="<?php echo $this->m->user_role(); ?>">
            ...
            <div class="list-group" role="tablist" id="tablistReservation">
              <?php if ($this->m->user()) : ?>
                <a href="#tabIsUser" role="tab" data-toggle="tab" class="list-group-item <?php echo $this->m->user() ? ' active ' : ''; ?>">
                  <h4 class="list-group-item-heading">Als Benutzer</h4>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade <?php echo $this->m->user() ? ' in active ' : ''; ?>" id="tabIsUser">
                  <div class="panel panel-default">
                    <div class="panel-heading">
                      <h3 class="panel-title">Als Benutzer</h3>
                    </div>
                      ...
                      <div id="step-2" class="step">
                        <fieldset class="form-horizontal">
                          ...
                          <div class="form-group" data-error-message="Bitte geben Sie Ihren Vornamen ein.">
                            <label for="regid" class="control-label col-sm-4">Benutzer-ID</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control" name="regid" id="regid" value="<?php echo $this->m->user_value('regid'); ?>" <?php echo $this->m->user() ? 'disabled="disabled"' : ''; ?> />
                            </div>
                          </div>
                          ...
                          <div class="form-group" data-error-message="Bitte wählen Sie Ihre Anrede aus.">
                            ...
                            <div class="col-sm-8">
                              <label class="radio-inline">
                                <input name="gender" type="radio" id="gender-1" value="1" <?php echo $this->m->user_radio('gender', '1'); ?> <?php echo $this->m->user_radio('gender', 'Female'); ?> <?php echo $this->m->user() ? 'disabled="disabled"' : ''; ?> />
                                Frau
                              </label>
                              <label class="radio-inline">
                                <input name="gender" type="radio" id="gender-2" value="2" <?php echo $this->m->user_radio('gender', '2'); ?> <?php echo $this->m->user_radio('gender', 'Male'); ?> <?php echo $this->m->user() ? 'disabled="disabled"' : ''; ?> />
                                Herr
                              </label>
                            </div>
                          </div>
                          ...
                          <div class="form-group" data-error-message="Bitte geben Sie Ihren Vornamen ein.">
                            ...
                            <div class="col-sm-8">
                              <input type="text" class="form-control" name="first_name" id="first_name" value="<?php echo $this->m->user_value('name'); ?>" <?php echo $this->m->user() ? 'disabled="disabled"' : ''; ?> />
                            </div>
                          </div>
                          ...
                          <div class="form-group" data-error-message="Bitte geben Sie Ihren Nachnamen ein.">
                            ...
                            <div class="col-sm-8">
                              <input type="text" class="form-control" name="last_name" id="last_name" value="<?php echo $this->m->user_value('surname'); ?>" <?php echo $this->m->user() ? 'disabled="disabled"' : ''; ?> />
                            </div>
                          </div>
                          ...
                          <div class="form-group" data-error-message="Bitte geben Sie Ihre E-Mail Adresse ein.">
                            ...
                            <div class="col-sm-8">
                              <input type="email" class="form-control" name="email" id="email" value="<?php echo $this->m->user_value('email'); ?>" <?php echo $this->m->user() ? 'disabled="disabled"' : ''; ?> />
                            </div>
                          </div>
                          ...
                          <div class="form-group" data-error-message="Bitte geben Sie eine gültige Telefonnummer ein.">
                            ...
                            <div class="col-sm-8">
                              <input type="telephone" class="form-control" name="telephone" id="telephone" value="<?php echo $this->m->user_value('telephone'); ?>" <?php echo $this->m->user() ? 'disabled="disabled"' : ''; ?> />
                            </div>
                          </div>

                          <div class="form-group">
                            <div class="col-sm-6 text-left">
                              <button type="button" class="btn btn-danger" id="terminLogout">Das bin ich nicht</button>
                            </div>
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              <p class="alert alert-info text-center">
                                ...
                                <a href="<?php echo site_url('portal/both/login/page?p&r='.rawurlencode($current_url).'&c='.rawurlencode($encrypted_url)); ?>"><br/><strong>Hier einloggen.</strong></a><br/>
                                oder
                                <a href="<?php echo site_url('portal/both/register/page?p&r='.rawurlencode($current_url).'&c='.rawurlencode($encrypted_url)); ?>"><br/><strong>Hier registrieren.</strong></a>
                              </p>
                            </div>
                          </div>
              ...
              <div class="tab-pane fade" id="tabFinalStep">
                <div class="panel panel-info">
                  <div class="panel-heading">
                    <h3 class="panel-title">Buchung</h3>
                  </div>
                  <div class="panel-body">
                    ...
                    <div id="step-3" class="step">
                      <fieldset class="form-horizontal">
                        ...
                        <div class="form-group">
                          <label for="inputSpeciality" class="col-sm-12">
                            Behandlungsgrund 
                          ...
                          <div class="col-sm-12">
                              <input type="text" name="speciality" class="form-control" id="inputSpeciality" data-placeholder="Wählen Spezialisierung ein" />
                              <!--
                            <select name="speciality[]" class="chosen-select bs-form-control" id="inputSpeciality" data-placeholder="Wählen Spezialisierung ein" multiple="multiple">
                          ...
                          <div class="form-group">
                          <label for="inputSpeciality" class="col-sm-12">Subscriber ID 
                          </label>
                          <div class="col-sm-12">
                              <?php echo $this->m->user_value('subscriber_id'); ?>
                          </div>
                        </div>
                          
                          <div class="form-group">
                          <label for="inputSpeciality" class="col-sm-12">Insurance
                          </label>
                          <div class="col-sm-12">
                              <?php 
                              $insurance_type = $this->m->user_value('insurance_type');
                              if(isset($insurance_type) && !empty($insurance_type))
                              {
                                  if($insurance_type == 'private')
                                  {
                                      echo 'Private Versicherung';
                                  }else if($insurance_type == 'legal'){
                                      echo 'Gesetzliche Versicherung';
                                  }
                              }
                              echo "&nbsp;-&nbsp;".$this->m->user_value('insurance_provider');
                              ?>
                          </div>
                        </div>
                        ...
                        <div class="form-group" data-error-message="Bitte wählen Sie Ihre Versicherungsart aus.">
                          ...
                          <div class="col-sm-12">
                            <label class="radio-inline">
                              <input name="insurance" type="radio" id="insurance-type-1" value="1" <?php echo $this->m->user_radio('insurance', '1'); ?> <?php echo $this->m->user() ? 'disabled="disabled"' : ''; ?> />
                              privat
                            </label>
                            <label class="radio-inline">
                              <input name="insurance" type="radio" id="insurance-type-2" value="2" <?php echo $this->m->user_radio('insurance', '2'); ?> <?php echo $this->m->user() ? 'disabled="disabled"' : ''; ?> />
                              gesetzlich
                            </label>
                          </div>
                        </div>
                         ...
                         <div class="form-group">
                          <label for="inputInsurance_provider" class="col-sm-12">
                            Versicherung 
                            <span class="optional-field">
                              (freiwillig)
                            </span>
                          ...
                          <div class="col-sm-12">
                            <select name="insurance_provider[]" class="chosen-select bs-form-control" id="inputInsurance_provider" data-placeholder="Bitte wählen Sie Ihre Versicherung aus.">
                        ...
                        <div class="form-group" data-error-message="Bitte geben Sie an, ob Sie schon einmal bei diesem Arzt in Behandlung waren.">
                          <div id="is-patient" class="radio-group">
                            <label class="col-sm-12">Waren Sie bereits Patient/in bei<br/><?php echo $doctor->academic_grade.' '.$doctor->name.' '.$doctor->surname; ?>?</label>
                            <div class="col-sm-12 ">
                              <label class="radio-inline">
                                <input name="returning_visitor" type="radio" id="is-patient-2" value="0" required >
                                Nein
                              </label>
                              <label class="radio-inline">
                                <input name="returning_visitor" type="radio" id="is-patient-1" value="1" required >
                                Ja
                              </label>
                            </div>
                          </div>
                        ...
                        <div class="form-group">
                          <label for="patient_notes" class=" col-sm-12">Notizen <span class="optional-field">(freiwillig)</span></label>
                          <div class="col-sm-12">
