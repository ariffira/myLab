...
<div class="already-registered">Sie haben noch keinen Ärzte-Zugang? <a href="<?php echo site_url('portal/doctor/login/post'); ?>">Hier registrieren.</a></div>
<h1>Ärzte-Management</h1>

<section id="form" class="col-md-6 col-sm-12">
  <form id="booking-form" class="" action="<?php echo site_url('portal/doctor/login/post'); ?>" method="post" enctype="application/x-www-form-urlencoded">
