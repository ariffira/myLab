...
<div class="form-group">
	...
	<div class="col-sm-10">
		<?php echo $reminder_email_subject ? $reminder_email_subject : 'Booking Reminder'; ?>
	</div>
</div>
...
<div class="well">
	...
	<p><?php echo $reminder_email_body ? $reminder_email_body: 'Just a quick reminder!'; ?></p>
	...
	<p><?php echo $reminder_email_closing ? $reminder_email_closing : 'Notes: Here comes the closing notes'; ?>
	</p>
