...
<table cellpadding='0' cellspacing='0'>
	<tr>
		<td>
			<b>
               <?php echo $this->lang->line('email_body_pat_id'); ?>
            </b>&nbsp;
			<b><?php echo $regid; ?></b>
		</td>
	</tr>
	<tr>
		<td>
			<b>
               <?php echo $this->lang->line('email_body_pat_pin'); ?>
			</b>&nbsp;
			<b><?php echo $pin; ?></b>
		</td>
	</tr>
...
<a href="<?php echo site_url().'/portal/patient/forgot/change_password';?>?email=<?php echo $email;?>&code=<?php echo $confirm_code;?>">
