...
<form class="form-horizontal" action="<?php echo site_url('portal/patient/forgot/email_reset_validation'); ?>" method="post" >
  <div class="form-group">
    ...
    <div class="col-sm-4">
      ...
      <p class="help-block">If you forgot password click here 
        <a href="<?php echo site_url('portal/patient/forgot/pass_reset'); ?>">
          Forgot password
        </a>
      </p>
    </div>
