    ...
    <div class="login_container">
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                ...
                <form class="form-horizontal" role="form" id="registrationForm" action="<?php echo site_url('portal/doctor/forgot/forcechange_password'); ?>" method="post">
...
<!--                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="password" class="form-control" name="password" id="inputPassword" value="<?php echo set_value('password'); ?>" title="Password must contain at least 6 characters, including UPPER/lowercase and numbers." required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" placeholder="New Password" required />
                        </div>
                    </div>
                    <!-- Password repeat -->
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-4 col-sm-2">
                            <button role="button" class="btn btn-purple btn-lg btn-full font-bold uprCase" type="submit" onclick="return validate()" style="margin-bottom:15px;" data-loading-text="Changing Password...">
                               Submit
                            </button>
                        </div>
