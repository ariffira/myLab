...
<a href="<?php echo site_url().'/portal/doctor/register/doctor_validation';?>?email=<?php echo $email;?>&code=<?php echo $confirm_code;?>" target="_blank">
...
<p><strong>
      <?php echo $this->lang->line('email_body_5')."<br>".$this->lang->line('email_body_6'); ?></strong></p>
</body>
</html>
