       ...
       <?php $this->ui->feed_item->rebase(); ?>
        <?php
          ...
          $this->ui->feed_item->content(
            'content',
            $this->load->view('condition/condition_home_view', array(
              'entry' => $entry,
...
{
echo "<a href='".site_url("akte/condition/feed/?id=purple&showmore=$show_more")."' class='show_more' id='show_more".$show_more."' ><div class='btn btn-default pull-right'>Show More</div></a>";
}
?>
<?php else: ?>
