...
//                        }
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="<?php echo site_url('akte/vital_values/delete/blood_sugar/'.$entry->id); ?>" class="btn btn-alt btn-xs btn-tool btn-tool-delete" id="<?php echo $btn_tool_delete_id = 'btnTool'.random_string('alnum', 32); ?>"><span class="icomoon i-remove-2"></span></a>
