...
//                        }
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="form-group">
                            <label><?php echo !empty($entry->INR) ? $entry->INR: ''; ?></label>
                          </div>
                        </td>
                        <td>
                          <div class="form-group">
                            <label><?php echo !empty($entry->quick) ? $entry->quick: ''; ?></label>
                          </div>
                        </td>
                        <td>
                          <a href="<?php echo site_url('akte/vital_values/delete/marcumar/'.$entry->id); ?>" class="btn btn-alt btn-xs btn-tool btn-tool-delete" id="<?php echo $btn_tool_delete_id = 'btnTool'.random_string('alnum', 32); ?>"><span class="icomoon i-remove-2"></span></a>
