...
<div class="row">
  <div class="col-sm-12 col-xs-12">
    ...
    <!-- <div class="page-header">
      <h1 class="text-center"><span class="icomoon i-inject"></span> Ärzte-Login</h1>
    </div> -->

    <div class="row">
      <div class="col-md-offset-4 col-md-4 alert alert-info text-center">
        Noch nicht registriert? <a href="<?php echo site_url('portal/both/register/page?d'); ?>" style="margin-left:15px;"><strong>Hier registrieren.</strong></a>
      </div>
    </div>
    ...
    <form class="form-horizontal" action="<?php echo site_url('portal/doctor/login/page/post'.(isset($r) && isset($c) && $r && $c ? ('?r='.rawurlencode($r).'&c='.rawurlencode($c)) : '')); ?>" method="post" enctype="application/x-www-form-urlencoded">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-4">
          ...
          <p class="help-block">Ich habe meinen Login-Namen / E-Mail-Adresse <a href="<?php echo site_url('portal/doctor/forgot/email_reset'); ?>">vergessen</a></p>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-sm-4">
          ...
          <p class="help-block">Ich habe mein Passwort <a href="<?php echo site_url('portal/doctor/forgot/pass_reset'); ?>">vergessen</a></p>
        </div>
      </div>
      <div class="form-group">
