...
<form class="form-horizontal" role="form" method="post" action="<?php echo site_url('akte/smokingstatus/update/'.$entries->id); ?>" enctype="multipart/form-data">
  ...
  <div class="row">
  <div class=" <?php echo empty($static) ? 'p-r-20' : 'm-b-5'; ?>">
    <label for="smoking<?php $entries->id; ?>" class="col-sm-3 control-label text-white"> 
      <?php echo $this->lang->line('smoking_heading_title'); ?>
    </label>
    <div class="col-sm-9">
        <select size="1" class="tag-select" name="smokingstatus" id="smokingstatus" >	
	<option value="">
