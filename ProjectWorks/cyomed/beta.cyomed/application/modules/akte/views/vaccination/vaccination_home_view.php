...
<div class="blog-block blog-blue">
 <div class="date-block"><div class="date-meta"><?php echo date('d',strtotime($entry->document_date));?>. <span><?php echo date('M',strtotime($entry->document_date));?></span></div></div>
  <div class="blog-text blog-text-val">
    <?php if (!empty($static)) : ?>
      <h2 class="title blue font_type1 uprCase"><?php echo $this->lang->line('patients_vaccination_card_vaccination'); ?></h2>
      <article>
      <div class="blog-img">
  	...
  	<?php endif; ?>
    <div class="category"><?php echo !empty($entry->Handelsname) ? form_prep($entry->Handelsname) : ''; ?></div>
    <div class="short-desc"><?php echo !empty($entry->Praxis) ? $entry->Praxis : ''; ?></div>
    <p class="form-val clr"><em><?php echo $this->lang->line('patients_vaccination_card_batch_no'); ?>: <?php echo !empty($entry->vaccination) ? form_prep($entry->vaccination) : ''; ?></em></p>
    <div class="row">
        <div class="col-md-6">
            <p class="form-val"><?php echo $this->lang->line('patients_vaccination_card_date'); ?>: <?php echo !empty($entry->document_date) ? date('d.m.Y', strtotime($entry->document_date)) : ''; ?></p>
        </div>
        <div class="col-md-6">
            <p class="form-val"><?php echo $this->lang->line('patients_vaccination_card_reminder_on'); ?>: <?php echo !empty($entry->date) ? date('d.m.Y', strtotime($entry->date)) : ''; ?></p>
        </div>
    </div>
    <p class="form-val multi-select-val clr"><select class="tag-select" disabled name="symptoms[]"  multiple="multiple" data-placeholder="Symptoms" >
    ...
    <form class="form form-horizontal hidden" role="form" method="post" action="<?php echo site_url('akte/vaccination/'.( !empty($insert) ? 'insert' : ('update/'.$entry->id) ) ); ?>" enctype="multipart/form-data" <?php echo !empty($readonly) ? 'data-readonly="readonly"' : ''; ?> <?php echo !empty($disabled) ? 'data-disabled="disabled"' : ''; ?> >
  ...
  <div class="form-group form-group1 <?php //echo empty($static) ? '' : 'm-b-5'; ?>">
    ...
    <label for="Handelsname<?php $entry->id; ?>" class="col-sm-5"> 
  ...
  <div class="form-group form-group1 <?php //echo empty($static) ? '' : 'm-b-5'; ?>">
    ...
    <label for="vaccination<?php $entry->id; ?>" class="col-sm-5"> 
  ...
  <div class="form-group form-group1 <?php //echo empty($static) ? '' : 'm-b-5'; ?>">
    ...
    <label for="document_date<?php echo $entry->id; ?>" class="col-sm-5">
  ...
  <div class="form-group form-group1 <?php //echo empty($static) ? '' : 'm-b-5'; ?>">
    ...
    <label for="date<?php echo $entry->id; ?>" class="col-sm-5">
  ...
  <div class="form-group form-group1 <?php //echo empty($static) ? '' : 'm-b-5'; ?>">
    ...
    <label for="symptoms<?php $entry->id; ?>" class="col-sm-5"> 
  ...
  <div class="form-group <?php //echo empty($static) ? '' : 'm-b-5'; ?>">
    ...
    <label for="Praxis<?php $entry->id; ?>" class="col-sm-3"> 
  ...
  <div style="display:none;" class="form-group <?php //echo empty($static) ? '' : 'm-b-5'; ?>">
    ...
    <label for="Datei<?php echo $entry->id; ?>" class="col-sm-3">
...
<div class="read-more"><div class="pull-left">
  ...
  </div><a href="<?php echo site_url('/akte/vaccination/index/'.$entry->id); ?>" class="ajax-vaccination-link<?php echo $entry->id; ?>">Details</a>&nbsp;<span class="fa fa-chevron-right fa-right"></span></div>
...
<script type="text/javascript">
        ...
        $('.ajax-vaccination-link<?php echo $entry->id; ?>').click(function(e) 
        {
          e.preventDefault();
