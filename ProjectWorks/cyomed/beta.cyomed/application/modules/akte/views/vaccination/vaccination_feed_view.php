       ...
       <?php $this->ui->feed_item->rebase(); ?>
        <?php
          ...
          $this->ui->feed_item->content(
            'content',
            $this->load->view('vaccination/vaccination_home_view', array(
              'entry' => $entry,
              'hide_insert' => TRUE,
              'static' => TRUE, 
              'readonly' => FALSE,
...
{
echo "<a href='".site_url("akte/vaccination/feed/?id=purple&showmore=$show_more")."' class='show_more' id='show_more".$show_more."' ><div class='btn btn-default pull-right'>Show More</div></a>";
}
?>
<?php else: ?>
