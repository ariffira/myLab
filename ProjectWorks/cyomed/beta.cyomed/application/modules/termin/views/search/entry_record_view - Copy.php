...
?>
<div class="doc-block">
      <h2 class="title"><a data-item-prop="url" id="doctor-profile<?php echo $doctor->id;?>" href="<?php echo site_url('/termin/profile/doctor/'.(isset($doctor->id) ? 'member' : 'google').'/'.(isset($doctor->id) ? $doctor->id : '')); ?>" data-fill="doctor-name"><?php echo isset($doctor->academic_grade) && isset($doctor->name) && isset($doctor->surname) ? $doctor->academic_grade.' '.$doctor->name.' '.$doctor->surname : ''; ?></a></h2>
       <div class="doc-address">   <?php echo $address; ?>&nbsp;&nbsp;<span><button class="btn btn-primary btn-xs gmap-relocate" id="gmap-relocate<?php echo $doctor->id;?>" data-toggle="collapse"  aria-expanded="false" aria-controls="collapseExample<?php echo $doctor->id;?>">&nbsp;&nbsp;&nbsp; <span class="icomoon i-location-4"></span> &nbsp;&nbsp;&nbsp;</button></span></div>
      ...
      <div class="row">
       ...
       <a class="btn btn-primary pull-right inlined" id="fulltermin-view-load<?php echo $doctor->id;?>" href="<?php echo site_url('termin/patient_termin'); ?>" class="ajax-condition-link82">Details&nbsp;</a>
</div>
<hr  />
<script>
