...
<div class="row">
  ...
  <div class="col-md-12">
    <form role="form" id="formTerminSettings" method="post" action="<?php echo site_url('termin/times/update_times'); ?>">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-7">
            <label class="radio-inline">
              <input type="radio" name="regular_termin_on" id="inputActivated1" value="1" <?php echo $this->m->user_radio('regular_termin_on', '1'); ?> > Nein
            </label>
            <label class="radio-inline">
              <input type="radio" name="regular_termin_on" id="inputActivated0" value="0" <?php echo $this->m->user_radio('regular_termin_on', '0'); ?> > Ja
            </label>
          </div>
        </div>
      </fieldset>
              ...
              <div class="panel panel-primary">
                ...
                <div class="panel-body">
                  ...
                  <div class="form-group hidden form-group-termin-wrapper">
                    ...
                    <div class="col-sm-5 form-inline text-center">
                      <label class="checkbox-inline">
                        <input type="checkbox" class="input-termin-insurance" value="1" > dfffPrivat versichert / Selbstzahler
                      </label>
                      <label class="checkbox-inline">
