...
<div class="row">
  ...
  <div class="col-md-12">
    <form class="form-horizontal" role="form" method="post" action="<?php echo site_url('admin/profile'); ?>" id="formAdminProfile" enctype="multipart/form-data" >
        ...
        <div class="row">
          <div class="col-md-8">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-4">
                <input class="form-control" name="title" id="inputTitle" value="<?php echo $this->mod->user_value('academic_grade'); ?>" />
              </div>
              <label for="inputGender" class="col-sm-2 control-label">Geschlecht</label>
              <div class="col-sm-4">
                <select class="form-control" name="gender" id="inputGender">
                  <option value="1" <?php echo $this->mod->user_select('gender', '1'); ?> >Weiblich</option>
                  <option value="2" <?php echo $this->mod->user_select('gender', '2'); ?> >Männlich</option>
                </select>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="number" class="form-control" name="postal_code" value="<?php echo $this->mod->user_value('zip'); ?>" id="inputPostalCode" placeholder="PLZ">
              </div>
            </div>
            <div class="form-group">
              <label for="inputLocality" class="col-sm-2 control-label">Stadt</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" name="locality" value="<?php echo $this->mod->user_value('city'); ?>" id="inputLocality" placeholder="Stadt">
              </div>
            </div>
            <div class="form-group">
              <label for="inputStreet" class="col-sm-2 control-label">Straße</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" name="street" value="<?php echo $this->mod->user_value('address'); ?>" id="inputStreet" placeholder="Straße">
              </div>
            </div>
            <div class="form-group">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <select size="8" class="form-control" name="speciality[]" id="inputSpeciality" data-toggle="mSelector" data-selector="#inputSpecialitySelector" data-control-up="#inputSpecialityMoveUp" data-control-down="#inputSpecialityMoveDown" data-control-delete="#inputSpecialityDelete" >
              <?php foreach ($this->mod->user()->native->specs_assoc as $code => $row) : ?>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <select size="8" class="form-control" name="languages[]" id="inputLanguages" data-toggle="mSelector" data-selector="#inputLanguagesSelector" data-control-up="#inputLanguagesMoveUp" data-control-down="#inputLanguagesMoveDown" data-control-delete="#inputLanguagesDelete" >
              <?php foreach ($this->mod->user()->native->langs_assoc as $code => $row) : ?>
      ...
      <fieldset>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <textarea class="form-control" rows="5" name="text_vet" id="inputVET" placeholder="Aus- und Weiterbildung"><?php echo $this->mod->user_value('text_vet'); ?></textarea>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
          ...
          <div class="col-md-6">
            ...
            <textarea class="form-control" rows="5" name="text_membership" id="inputMembership" placeholder="Mitgliedschaften"><?php echo $this->mod->user_value('text_membership'); ?></textarea>
          </div>
        </div>
        <!-- <div class="row">
          <div class="col-md-6">
