...
<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/stylesheets/docs.min.css'); ?>" />
<style type="text/css">
...
.form-control,
.chosen-select.bs-form-control .chosen-single,
.form-control-radio,
...
.btn-danger,
.action.integration_8 .message > a {
  color: #ffffff;
...
html.clean {
  position: relative;
  min-height: 100%;
  /* Sticky footer styles _ Custom page CSS */
...
html.clean body > .navbar .navbar-brand {
  height: 93px;
}
html.clean body > .navbar .navbar-default .navbar-nav > li > a {
  height: 93px;
  padding-top: 35px;
  padding-bottom: 35px;
}
html.clean body > .container {
  padding: 113px 15px 0;
}
html.clean .container .text-muted {
  margin: 20px 0;
}
html.clean .footer > .container {
  padding-right: 15px;
  padding-left: 15px;
}
.text-case-none {
...
#owlDoctors .item .round-image img {
  width: 100%;
}
#owlDoctors .specialty,
#owlDoctors .city {
  color: #666;
}
.owl-calendar.calendar .col {
...
.owl-calendar.calendar .col .col-header {
  color: #000;
  background-color: #eeeeee;
  padding: 0 3px;
}
.owl-calendar.calendar .col .col-header .day {
  text-transform: uppercase;
  margin-right: 3px;
}
.owl-calendar.calendar .col .col-header .date {
  font-weight: 700;
  white-space: nowrap;
  overflow: hidden;
  text-overflow: ellipsis;
}
.owl-calendar.calendar .col a:hover {
  text-decoration: underline;
}
.owl-calendar.calendar .arrow {
  width: 16px;
  background: #f5f5f5;
  height: 100%;
  position: absolute;
...
.owl-calendar.calendar .arrow:before {
  content: " ";
  display: block;
  position: absolute;
  height: 100%;
...
.owl-calendar.calendar .arrow:after {
...
.owl-calendar.calendar .arrow.left {
  left: 0;
}
.owl-calendar.calendar .arrow.left:before {
  left: -100%;
  margin-left: 100%;
  ...
  background: -o-linear-gradient(right, rgba(255, 255, 255, 0) 20%, rgba(255, 255, 255, 0.1) 50%, rgba(255, 255, 255, 0.9));
  background: linear-gradient(right, rgba(255, 255, 255, 0) 20%, rgba(255, 255, 255, 0.1) 50%, rgba(255, 255, 255, 0.9));
  background: -ms-linear-gradient(right, rgba(255, 255, 255, 0) 20%, rgba(255, 255, 255, 0.1) 50%, rgba(255, 255, 255, 0.9));
}
.owl-calendar.calendar .arrow.left:after {
  content: "\e3b3";
}
.owl-calendar.calendar .arrow.right {
  right: 0;
}
.owl-calendar.calendar .arrow.right:before {
  right: -100%;
  margin-right: 100%;
  ...
  background: -o-linear-gradient(left, rgba(255, 255, 255, 0) 20%, rgba(255, 255, 255, 0.1) 50%, rgba(255, 255, 255, 0.9));
  background: linear-gradient(left, rgba(255, 255, 255, 0) 20%, rgba(255, 255, 255, 0.1) 50%, rgba(255, 255, 255, 0.9));
  background: -ms-linear-gradient(left, rgba(255, 255, 255, 0) 20%, rgba(255, 255, 255, 0.1) 50%, rgba(255, 255, 255, 0.9));
}
.owl-calendar.calendar .arrow.right:after {
  content: "\e3b1";
}
.owl-calendar.calendar.medium {
  overflow: hidden;
  height: 200px;
}
.owl-calendar.calendar.medium .col {
  min-height: 250px;
}
.owl-calendar.calendar.medium .arrow {
  line-height: 200px;
}
.owl-calendar.calendar.exception .col {
  background: #f5f5f5;
}
.owl-calendar.calendar.exception .action {
  position: absolute;
  background: #fff;
  left: 3rem;
  right: 3rem;
...
.owl-calendar.calendar.exception .action .message {
  text-align: center;
  margin: auto;
}
.owl-calendar.calendar.exception.type-no-available-appointments .action {
  font-weight: 700;
}
.appointment {
...
.chosen-select.bs-form-control.chosen-container {
  width: 100% !important;
}
.chosen-select.bs-form-control .chosen-single div b {
  background-position: 0 7px;
}
.chosen-select.bs-form-control.chosen-container-active.chosen-with-drop .chosen-single div b {
            ...
            <div class="bs-callout bs-callout-info">
              <div class="media">
                ...
                <div class="media-body">
                  ...
                  <div class="name"><a href="<?php echo isset($doctor->website) && $doctor->website ? $doctor->website : '#'; ?>">Praxis <?php echo $doctor->academic_grade.' '.$doctor->name.' '.$doctor->surname; ?></a></div>
            ...
            <div class="panel-body">
              ...
              <div class="form-horizontal">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <p class="alert alert-info text-center">
                      ...
                      <?php if (isset($success_info) && is_array($success_info) && count($success_info) > 0 && isset($success_info['email'])): ?>
                        A confirmation is sent to <a href="#"><strong><?php echo  $success_info['email']; ?></strong></a>
                      <?php endif; ?>
                    </p>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <p class="form-control-static">
                      <span class="datetime momentjs" data-datetime="<?php echo $termin->start; ?>"></span> 
                      <?php echo $termin->start; ?>                 
                    </p>
                  </div>
                </div>
                ...
                <?php if (isset($success_info) && is_array($success_info) && count($success_info) > 0) : foreach ($success_info as $key => $value) : ?>
                  ...
                  <div class="form-group">
                    <label class="control-label col-sm-4"><?php echo $this->lang->line($key) ? $this->lang->line($key) : $key; ?></label>
                    <div class="col-sm-8">
                      <p class="form-control-static">
                        <?php if($key == 'gender') : ?>
