    ...
    <div class="login_container">
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                ...
                <form class="form-horizontal" role="form" id="registrationForm" action="<?php echo site_url('portal/doctor/forgot/security_response'); ?>" method="post">
                     <!-- Question -->
                    <div class="form-group">
                        <label for="inputPassword3" class="col-sm-6 pull-left text-left control-label">
                            1. Select Security Question<span class="text-danger">*</span></label>
                        <div class="col-sm-12">
