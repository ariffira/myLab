...
<form class="form-horizontal" action="<?php echo site_url('portal/doctor/forgot/pass_reset_validation'); ?>" method="post" id="frm_doctor_forgot_pass">
    ...
    <div class="col-md-4 col-sm-7">
      <input type="email" class="form-control" name="email" id="email" value="" placeholder="email" required/>
		<p class="help-block text-left">
        	...
        	<a href="<?php echo site_url('portal/both/login/page?d'); ?>">
