...
<p>sie haben sich unter dieser Email Adresse bei Cyomed registriert.</p>
<p>Bitte klicken Sie auf den folgenden Link, um Ihre Email Adresse zu bestätigen. Hier Ihre Email addresse zu 

<a href="<?php echo site_url().'/doctor/register/doctor_validation';?>?email=<?php echo $email;?>&code=<?php echo $confirm_code;?>">Bestätigen</a> </p>
