...
<div id="wrapper">
  ...
  <div class="content">
    ...
    <div class="container">
      ...
      <h2 class="">Tabs & Accordions</h2>

      <br><br>

      <section class="demo-section">

        <h4 class="content-title"><u>Tab Navigation</u></h4>
      ...
      <section class="demo-section">
        ...
        <h4 class="content-title"><u>Pill Tabs</u></h4>
      ...
      <section class="demo-section">
        ...
        <h4 class="content-title"><u>Stacked Tabs</u></h4>
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-5">
            ...
            <ul id="myTab" class="nav nav-pills nav-stacked">
              ...
              <li class="dropdown">
                <a href="javascript:;" id="myTabDrop3" class="dropdown-toggle" data-toggle="dropdown">
                  <i class="fa fa-chevron-sign-down"></i> &nbsp;&nbsp;Dropdown <b class="caret"></b>
                </a>
      ...
      <section class="demo-section">
        ...
        <h4 class="content-title"><u>Accordion Simple</u></h4>
      ...
      <section class="demo-section">
        ...
        <h4 class="content-title"><u>Accordion Panel</u></h4>
