...
<!--[if IE 9 ]><html class="ie9"><![endif]-->
    <head>
        ...
        <link href="<?php echo base_url('assets/sa103/css/animate.css'); ?>" rel="stylesheet">
    ...
    <body id="skin-blur-violate">
        <section id="login">
            ...
            <form class="box tile animated active" id="box-login">
                ...
                <small>
                    <a class="box-switcher" data-switch="box-register" href="javascript:void(0);">Don't have an Account?</a> or
                    <a class="box-switcher" data-switch="box-reset" href="javascript:void(0);">Forgot Password?</a>
                </small>
            </form>
            ...
            <form class="box animated tile" id="box-register">
                ...
                <small><a class="box-switcher" data-switch="box-login" href="javascript:void(0);">Already have an Account?</a></small>
            </form>
