...
<!--[if IE 9 ]><html class="ie9"><![endif]-->
    <head>
        ...
        <!-- CSS -->
        <link href="<?php echo base_url('assets/sa103/css/bootstrap.min.css'); ?>" rel="stylesheet">
        <link href="<?php echo base_url('assets/sa103/css/animate.min.css'); ?>" rel="stylesheet">
        <link href="<?php echo base_url('assets/sa103/css/font-awesome.min.css'); ?>" rel="stylesheet">
        <link href="<?php echo base_url('assets/sa103/css/form.css'); ?>" rel="stylesheet">
        <link href="<?php echo base_url('assets/sa103/css/calendar.css'); ?>" rel="stylesheet">
        <link href="<?php echo base_url('assets/sa103/css/style.css'); ?>" rel="stylesheet">
        <link href="<?php echo base_url('assets/sa103/css/icons.css'); ?>" rel="stylesheet">
        <link href="<?php echo base_url('assets/sa103/css/generics.css"'); ?>" rel="stylesheet"> 
    </head>
        ...
        <section id="main" class="p-relative" role="main">
            ...
            <aside id="sidebar">
                ...
                <div class="side-widgets overflow">
                    ...
                    <div class="text-center s-widget m-b-25 dropdown" id="profile-menu">
                        ...
                        <ul class="dropdown-menu profile-menu">
                            ...
                            <li><a href="javascript:void(0);">Sign Out</a> <i class="icon left">&#61903;</i><i class="icon right">&#61815;</i></li>
                        </ul>
                ...
                <ul class="list-unstyled side-menu">
                    ...
                    <li class="dropdown">
                        <a class="sa-side-form" href="javascript:void(0);">
                    ...
                    <li class="dropdown">
                        <a class="sa-side-ui" href="javascript:void(0);">
                    ...
                    <li class="dropdown">
                        <a class="sa-side-photos" href="javascript:void(0);">
                    ...
                    <li class="dropdown">
                        <a class="sa-side-page" href="javascript:void(0);">
            ...
            <section id="content" class="container">
                ...
                <div id="messages" class="tile drawer animated">
                    <div class="listview narrow">
                        <div class="media">
                            <a href="javascript:void(0);">Send a New Message</a>
                        ...
                        <div class="overflow" style="height: 254px">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <a class="t-overflow" href="javascript:void(0);">Mauris consectetur urna nec tempor adipiscing. Proin sit amet nisi ligula. Sed eu adipiscing lectus</a>
                                </div>
                            </div>
                            <div class="media">
                                <div class="pull-left">
                                ...
                                <div class="media-body">
                                    ...
                                    <a class="t-overflow" href="javascript:void(0);">Suspendisse in purus ut nibh placerat Cras pulvinar euismod nunc quis gravida. Suspendisse pharetra</a>
                                </div>
                            </div>
                            <div class="media">
                                <div class="pull-left">
                                ...
                                <div class="media-body">
                                    ...
                                    <a class="t-overflow" href="javascript:void(0);">Maecenas venenatis enim condimentum ultrices fringilla. Nulla eget libero rhoncus, bibendum diam eleifend, vulputate mi. Fusce non nibh pulvinar, ornare turpis id</a>
                                </div>
                            </div>
                            <div class="media">
                                <div class="pull-left">
                                ...
                                <div class="media-body">
                                    ...
                                    <a class="t-overflow" href="javascript:void(0);">Phasellus interdum felis enim, eu bibendum ipsum tristique vitae. Phasellus feugiat massa orci, sed viverra felis aliquet quis. Curabitur vel blandit odio. Vestibulum sagittis quis sem sit amet tristique.</a>
                                </div>
                            </div>
                            <div class="media">
                                <div class="pull-left">
                                ...
                                <div class="media-body">
                                    ...
                                    <a class="t-overflow" href="javascript:void(0);">Ipsum wintoo consectetur urna nec tempor adipiscing. Proin sit amet nisi ligula. Sed eu adipiscing lectus</a>
                                </div>
                            </div>
                            <div class="media">
                                <div class="pull-left">
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <a class="t-overflow" href="javascript:void(0);">Integer a eros dapibus, vehicula quam accumsan, tincidunt purus</a>
                                </div>
                            </div>
                        </div>
                        <div class="media text-center whiter l-100">
                            <a href="javascript:void(0);"><small>VIEW ALL</small></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="block-area shortcut-area">
                    <a class="shortcut tile" href="javascript:void(0);">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="tile">
                                ...
                                <div class="tile-config dropdown">
                                    <a data-toggle="dropdown" href="javascript:void(0);" class="tile-menu"></a>
                                    <ul class="dropdown-menu pull-right text-right">
                                        <li><a class="tile-info-toggle" href="javascript:void(0);">Chart Information</a></li>
                                        ...
                                        <div class="listview narrow">
                                            <div class="media p-l-5">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <a class="t-overflow" href="javascript:void(0);">Cras molestie fermentum nibh, ac semper</a>
                                            ...
                                            <div class="media p-l-5">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <a class="t-overflow" href="javascript:void(0);">Suspendisse in purus ut nibh placerat</a>
                                            ...
                                            <div class="media p-l-5">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <a class="t-overflow" href="javascript:void(0);">Cras pulvinar euismod nunc quis gravida. Suspendisse pharetra</a>
                                            ...
                                            <div class="media p-l-5">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <a class="t-overflow" href="javascript:void(0);">Cras pulvinar euismod nunc quis gravida. </a>
                                ...
                                <div class="col-md-6">
                                    <div class="tile">
                                        ...
                                        <div class="tile-config dropdown">
                                            <a data-toggle="dropdown" href="javascript:void(0);" class="tile-menu"></a>
                                            <ul class="dropdown-menu pull-right text-right">
                                                <li id="todo-add"><a href="javascript:void(0);">Add New</a></li>
                                                <li id="todo-refresh"><a href="javascript:void(0);">Refresh</a></li>
                                                <li id="todo-clear"><a href="javascript:void(0);">Clear All</a></li>
                                            </ul>
                                        </div>
